<x-layouts.guest :title="'Login — HobbyHub'">
    <h2 class="text-2xl font-bold text-gray-900 text-center mb-2">Welcome back</h2>
    <p class="text-sm text-gray-500 text-center mb-8">Sign in to your HobbyHub account</p>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div>
            <div class="flex items-center justify-between mb-1.5">
                ...
                <a href="{{ route('password.request') }}" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">Forgot?</a>
            </div>
        ...
        <div class="flex items-center gap-2">
            <input type="checkbox" id="remember" name="remember" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
    ...
    @if(config('community.features.social_login'))
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm"><span class="bg-white px-3 text-gray-400">or continue with</span></div>
            </div>
    ...
    <p class="mt-8 text-center text-sm text-gray-500">
        Don't have an account? <a href="{{ route('register') }}" class="font-semibold text-indigo-600 hover:text-indigo-700">Sign up free</a>
    </p>
</x-layouts.guest>
